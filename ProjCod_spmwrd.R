# Data Mining Project Code1

#### Parts of the code are taken from the book Machine Learning for Hackers

# Calculating the top 100 words that can be used a spam for prediction
#-----------------------------------------------------------------------
...
# Function for extraction Emails
#---------------------------------

# We set the directories where data is stored
spam.data <- '/home/prateek/UVa/Data_Mining/workspace/project_data/spam/'
easyham.data <- '/home/prateek/UVa/Data_Mining/workspace/project_data/easy_ham/'
spam2.data <- '/home/prateek/UVa/Data_Mining/workspace/project_data/spam_2/'
easyham2.data <- '/home/prateek/UVa/Data_Mining/workspace/project_data/easy_ham_2/'
hardham.data <- '/home/prateek/UVa/Data_Mining/workspace/project_data/hard_ham/'

# Extracting the body of the emails, as explained in the book, the email always start after the line break.
...
# extracting the Easy_Ham emails in a vector
...
# Calculation of top 100 spam words
#-----------------------------------

### The below code is based on the concepts given by Shahar Yifrah and Guy Lev in their machine learning
# final project on email spam filtering, 2013, http://www.cs.tau.ac.il/~shaharyi/ml_final_project_2013.html

# calculating the spamicity
match.df <- data.frame(matrix(ncol=3, nrow = 3377))
...
### Not Required.. initial testing/reference code.. ignore the below code
